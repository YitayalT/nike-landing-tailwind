...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container  ml-10 p-2"
    >
      ...
      xl:min-h-screen max-xl:py-40 bg-hero bg-primary bg-cover bg-center">
        <img src={bigShoeImg} alt="shoe image one" width={610} height={500}
